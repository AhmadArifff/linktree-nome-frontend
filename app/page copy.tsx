...
// ============================================================
// app/page.tsx
// Halaman utama publik — logo toko di tengah + grid kategori
// Satu file lengkap: fetch data, render, animasi
// ============================================================

import { useEffect, useState } from 'react'
import Link from 'next/link'
import Image from 'next/image'
import { analyticsApi, storeApi, categoriesApi, getCategoryColor, StoreProfile, Category } from '@/lib/api'
...
export default function HomePage() {
  ...
  // Warna tema dari store, fallback ke brand purple
